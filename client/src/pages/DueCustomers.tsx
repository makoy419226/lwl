              ...
              <Table>
                ...
                <TableBody>
                  {dueCustomers.map((client) => {
                    ...
                    const totalClientDue =
                      previousBalance + pendingOrderAmount + pendingBillAmount;
                    if (totalClientDue <= 0) {
                      return;
                    }
                    return (
                      <TableRow
                        key={client.id}
                        data-testid={`row-due-customer-${client.id}`}
                      >
                        <TableCell>
                          ...
                          {pendingOrderData ? (
                            <div className="flex flex-col items-end">
                              <span className="text-blue-600 font-medium">
                                AED {pendingOrderAmount.toFixed(2)}
                              </span>
                              <span className="text-xs text-muted-foreground">
                                {pendingOrderData.count} order(s)
                              </span>
                            </div>
                          ) : (
                            <span className="text-muted-foreground">-</span>
                          ...
                          {pendingBillData ? (
                            <div className="flex flex-col items-end">
                              <span className="text-amber-600 font-medium">
                                AED {pendingBillAmount.toFixed(2)}
                              </span>
                              <span className="text-xs text-muted-foreground">
                                {pendingBillData.count} bill(s)
                              </span>
                            </div>
                          ) : (
                            <span className="text-muted-foreground">-</span>
                        ...
                        <TableCell>
                          <div className="flex items-center justify-center gap-2">
                            ...
                            <Button
                              size="sm"
                              onClick={() => handlePayNow(client)}
                              className="text-green-600 bg-white"
                              data-testid={`button-pay-${client.id}`}
                            >
                              Pay Now
                            </Button>
                            {client.phone && (
