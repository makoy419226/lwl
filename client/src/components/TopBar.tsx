    ...
    <div className="sticky top-0 z-30 w-full bg-white/80 backdrop-blur-md border-b border-border shadow-sm">
      <div className="h-16 lg:h-20 px-4 lg:px-6 flex items-center justify-between gap-3 lg:gap-4">
        ...
        <div className="flex-1 max-w-md relative group">
          ...
          <Input
            className="pl-10 h-12 lg:h-11 rounded-full border-2 border-muted bg-muted/30 focus:bg-white focus:border-primary/50 transition-all duration-300 touch-manipulation"
