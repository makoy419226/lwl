...
const laundryItems = [
  ...
  {
    name: "T-Shirt (Normal)",
    description: "Regular t-shirt wash",
    price: "3.00",
    category: "Tops",
    stockQuantity: 0,
    sku: "TSHI-001",
  ...
  {
    name: "T-Shirt (Dry Clean)",
    description: "T-shirt dry cleaning",
    price: "5.00",
    category: "Tops",
    stockQuantity: 0,
    sku: "TSHI-002",
  ...
  {
    name: "Track Pant (Normal)",
    description: "Regular track pant wash",
    price: "4.00",
    category: "Bottoms",
    stockQuantity: 0,
    sku: "TRAC-001",
  ...
  {
    name: "Track Pant (Dry Clean)",
    description: "Track pant dry cleaning",
    price: "6.00",
    category: "Bottoms",
    stockQuantity: 0,
    sku: "TRAC-002",
  ...
  {
    name: "Suit/Coat (Normal)",
    description: "Regular suit/coat wash",
    price: "25.00",
  ...
  {
    name: "Suit/Coat (Dry Clean)",
    description: "Suit/coat dry cleaning",
    price: "35.00",
    category: "Formal Wear",
    stockQuantity: 0,
    sku: "SUIT-002",
...
export async function seedDatabase() {
  ...
  const hasCorrectProducts = existingProducts.some(
    (p) => p.name === "Kandoora/Thob",
  );
